...
// 	{ name: "Escrows", href: "/escrow", icon: UsersIcon, current: false },
// ];
...
const Layout = ({ children }) => {
	...
	const navigation = [
		...
		},
		{
			...
			href: "/escrow",
			icon: UsersIcon,
			current: router.pathname === "/escrow" ? true : false,
		},
		{
			name: "Products",
			href: "/products",
	...
	const web3 = new Web3(
		new Web3.providers.HttpProvider(
			"https://polygon-mumbai.g.alchemy.com/v2/13TZ30CZy7xLxviwbgmdLMrGuKJDtWke"
		)
	);
